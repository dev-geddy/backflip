...
import { BRAND_SEPARATOR, TITLE_PREFIX } from "./_lib/crumbs"

/**
 * Tab titles for the whole admin scope. Pages set only their trail
 * (`titleFor()`), and this composes "B · Settings › My account" — a middle dot
 * joins the brand, chevrons separate path hops. Declared here
...
export const metadata: Metadata = {
  title: {
    template: `${TITLE_PREFIX}${BRAND_SEPARATOR}%s`,
    default: `${TITLE_PREFIX}${BRAND_SEPARATOR}Admin`,
  },
}
